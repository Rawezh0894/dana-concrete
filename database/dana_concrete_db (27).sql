...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 11, 2025 at 12:43 PM
...
(1, 'چاوی ١', 'چاو', 'لمی ڕەش', 101480.00, 2029.60, 0.02),
(2, 'چاوی ٢', 'چاو', 'لمی کەسارە', 33170.00, 0.00, 0.00),
(3, 'چاوی ٣', 'چاو', 'چەو', 142945.00, 1429.45, 0.01),
(4, 'چاوی ٤', 'چاو', 'چەو', 11080.00, 0.00, 0.00),
(5, 'سایلۆی ١', 'سایلۆ', 'چیمەنتۆ', 43465.00, 0.00, 0.00),
(6, 'سایلۆی ٢', 'سایلۆ', 'چیمەنتۆ', 31325.00, 0.00, 0.00),
(7, 'تەنکی دەرمان ١', 'تەنکی', 'دەرمان', 49802.00, 0.00, 0.00),
...
(14, '2025-07-10', 'deposit', 0.00, 500.00, 'دۆلار', '', 1, '2025-07-10 18:41:06'),
(15, '2025-07-09', 'deposit', 0.00, 100.00, 'دۆلار', 'فرۆشتن: invoice 123', NULL, '2025-07-10 18:47:46'),
(17, '2025-07-09', 'deposit', 0.00, 86.80, 'دۆلار', 'فرۆشتن: invoice 4375', NULL, '2025-07-10 18:51:50'),
(19, '2025-07-10', 'deposit', 0.00, 666.67, 'دۆلار', 'گەڕاندنەوەی قەرزی کڕیار', NULL, '2025-07-10 18:57:16'),
(20, '2025-07-10', 'deposit', 249000.00, 0.00, 'دینار', 'گەڕاندنەوەی قەرزی کۆمپانیا: 20', 1, '2025-07-10 19:15:49'),
(22, '2025-07-11', 'deposit', 0.00, 400.00, 'دۆلار', 'گەڕاندنەوەی قەرزی کۆمپانیا: 15', 1, '2025-07-11 10:43:14');
...
(15, 'test2', 0.00, 0.00, 0.00, 0.00, 'دۆلار'),
(18, 'TEST3', 20.00, 0.00, 500.00, 0.00, 'دۆلار'),
(20, 'TEST4', 0.00, 0.00, 0.00, 990.00, 'دینار'),
(21, 'test56', 4850.00, 0.00, 0.00, 0.00, 'دۆلار'),
...
(6, 'A-0005', 8, 'کوردتان', 20.00, 30, 4, 34, 5, 37, '2025-07-10 11:35:48', NULL);
...
(11, 'test2', '07501211541', '', 0.00, 0.00, 0.00, 0.00),
...
(34, 11, '2025-07-10', 150000.00, 666.67, 0.00, 0.00, '', 466.67, 200.00);
...
(28, 15, '2025-07-11', 400.00, 0.00, '', 1, 150000.00);
...
CREATE TRIGGER `trg_before_delete_debt_payments` BEFORE DELETE ON `debt_payments` FOR EACH ROW BEGIN
    IF OLD.note = 'قەرز دانەوە' THEN
        IF OLD.amount_usd > 0 THEN
            DELETE FROM cash_box
            WHERE `date` = OLD.date AND `type` = 'withdraw' AND amount_usd = OLD.amount_usd AND currency = 'دۆلار' AND note = CONCAT('قەرز دانەوە بۆ کۆمپانیا: ', OLD.company_id);
        END IF;
        IF OLD.amount_iqd > 0 THEN
            DELETE FROM cash_box
            WHERE `date` = OLD.date AND `type` = 'withdraw' AND amount_iqd = OLD.amount_iqd AND currency = 'دینار' AND note = CONCAT('قەرز دانەوە بۆ کۆمپانیا: ', OLD.company_id);
        END IF;
    ELSE
        IF OLD.amount_usd > 0 THEN
            DELETE FROM cash_box
...
CREATE TRIGGER `trg_before_delete_employee_payments` BEFORE DELETE ON `employee_payments` FOR EACH ROW BEGIN
    DELETE FROM cash_box
    WHERE `date` = OLD.created_at AND `type` = 'withdraw' AND amount_iqd = OLD.salary AND currency = 'دینار' AND note = CONCAT('پارەدان بە کارمەند: ', OLD.employee_id);
END
$$
DELIMITER ;
DELIMITER $$
...
(1310, 11, '', 's', 3.00, 50.00, 150.00, 'قەرز', 0.00, 0.00, 150000.00, 0.00, '544885', '2025-07-04', '', 17, 0.00),
(1311, 11, '', 'س', 2.00, 50.00, 100.00, 'قەرز', 0.00, 0.00, 150000.00, 0.00, '45454', '2025-07-04', '', 19, 0.00),
...
(1324, 8, 'سلێمانی', 'کوردتان', 2.00, 50.00, 100.00, 'نەقد', 100.00, 0.00, 150000.00, 0.00, '123', '2025-07-09', '', 19, 0.00),
(1325, 4, 'سلێمانی', 'کوردتان', 2.00, 43.40, 86.80, 'نەقد', 86.80, 0.00, 150000.00, 0.00, '4375', '2025-07-09', '', 18, 0.00);
