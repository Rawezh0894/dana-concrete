...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 24, 2025 at 08:52 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetMaterialStockHistory` (IN `p_bin_id` INT, IN `p_start_date` DATE, IN `p_end_date` DATE)   BEGIN
    SELECT 
        mms.id,
        mms.bin_id,
        mms.bin_name,
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `RecordMonthlyMaterialStock` (IN `p_month_year` VARCHAR(7), IN `p_user_id` INT)   BEGIN
...
CREATE DEFINER=`root`@`localhost` FUNCTION `GetMaterialStockForDate` (`p_bin_id` INT, `p_target_date` DATE) RETURNS DECIMAL(10,2) DETERMINISTIC READS SQL DATA BEGIN
...
(1, 'چاوی ١', 'چاو', 'لمی کەسارە', 114320.00, 1135161.88, 9.9296875000),
(2, 'چاوی ٢', 'چاو', 'لمی ڕەش', 294450.00, 3018112.50, 10.2500000000),
(3, 'چاوی ٣', 'چاو', 'چەو', 194840.00, 1136501.72, 5.8330000000),
(4, 'چاوی ٤', 'چاو', 'چەو', 2026840.00, 11822557.72, 5.8330000000),
(5, 'سایلۆی ١', 'سایلۆ', 'چیمەنتۆ', 0.00, 0.00, 0.0000000000),
(6, 'سایلۆی ٢', 'سایلۆ', 'چیمەنتۆ', 19989400.00, 0.00, 0.0000000000),
(7, 'تەنکی دەرمان ١', 'تەنکی', 'دەرمان', 19999905.00, 0.00, 0.0000000000),
(8, 'تەکی گاز ١', 'تەنکی', 'گاز', 9480.00, 80000.00, 8.0000000000),
...
(78, '2025-09-18', 'deposit', 0.00, 4.03, 'دۆلار', 'گەڕاندنەوەی قەرزی کڕیار', NULL, '2025-09-18 06:17:19'),
(79, '2025-09-18', 'deposit', 0.00, 990.00, 'دۆلار', 'گەڕاندنەوەی قەرزی کڕیار', NULL, '2025-09-18 06:19:02'),
(83, '2025-09-18', 'deposit', 643000.00, 0.00, 'دینار', 'گەڕاندنەوەی قەرزی کڕیار', NULL, '2025-09-18 06:32:46');
...
(31, 'دەشتی', 0.00, 0.00, 'دینار'),
(32, 'سۆران', 0.00, 0.00, 'دینار');
...
(70, 'A-0031', 32, 'سلێمانی', 12.00, 0.00, 19, 8, 26, 19, 35, '2025-08-11 12:23:37', NULL, 'ڕاوێژ ', NULL, 'unpaid'),
(71, 'A-0032', 32, 'سلێمانی', 5.00, 0.00, 19, 8, 26, 21, 34, '2025-08-11 12:34:19', NULL, 'ڕاوێژ ', NULL, 'unpaid'),
(72, 'A-0033', 32, 'سلێمانی', 4.00, 0.00, 19, 8, 26, 21, 37, '2025-08-11 12:42:17', NULL, 'ڕاوێژ ', NULL, 'unpaid');
...
(32, 'test', '07709245644', '', 10.00, 0.00);
...
INSERT INTO `customer_debt_payments` (`id`, `customer_id`, `date`, `dolar_rate`, `paid_usd`, `paid_iqd`, `discount`, `note`, `payment_type`, `from_opening_debt_usd`, `from_sales_usd`) VALUES
(4, 32, '2025-07-28', 139000.00, 50.00, 50000.00, 0.0000, '', 'fifo', 85.97, 0.00),
(7, 32, '2025-09-18', 142850.00, 4.03, 0.00, 0.0000, '', 'opening_debt_only', 4.03, 0.00),
(8, 32, '2025-09-18', 142850.00, 990.00, 0.00, 0.0000, '', 'specific_sales', 0.00, 990.00),
(12, 32, '2025-09-18', 143000.00, 0.00, 643000.00, 0.3496, '', 'specific_sales', 0.00, 450.00);
...
INSERT INTO `customer_payment_allocations` (`id`, `debt_payment_id`, `sale_id`, `allocated_amount`, `created_at`) VALUES
(1, 8, 12, 450.00, '2025-09-18 06:19:02'),
(2, 8, 16, 540.00, '2025-09-18 06:19:02'),
(3, 12, 14, 450.00, '2025-09-18 06:32:46');
...
(278, 1, 'delete', 'debt_payments', 29, 'پارەدانی قەرزی کۆمپانیا سڕایەوە (کۆمپانیا: دەرمان MHA)', '2025-08-10 10:20:57', 0, '{\"company_id\":30,\"company_name\":\"دەرمان MHA\",\"amount_usd\":4000,\"amount_iqd\":0,\"date\":\"2025-08-09\",\"note\":\"\"}', NULL, '{\"action_type\":\"company_debt_payment_deletion\",\"payment_method\":\"USD\",\"total_amount\":4000,\"discount_usd\":8}', '::1'),
(279, 1, 'insert', 'debt_payments', 30, 'پارەدان بۆ قەرزی کۆمپانیا زیادکرا (کۆمپانیا: دەرمان MHA)', '2025-08-10 10:21:10', 0, NULL, '{\"company_id\":\"30\",\"company_name\":\"دەرمان MHA\",\"date\":\"2025-08-10\",\"amount_usd\":4000,\"amount_iqd\":0,\"discount_usd\":8,\"dollar_rate\":139250,\"note\":\"\",\"created_by\":1}', '{\"action_type\":\"company_debt_payment\",\"payment_method\":\"USD\",\"total_amount\":4000}', '::1'),
(280, 1, 'update', 'purchases', 60, 'کڕینەکە نوێکرایەوە (invoice: 408, کۆمپانیا: Rawezh, مادە: لمی ڕەش)', '2025-08-13 09:59:50', 0, '{\"company_id\":27,\"company_name\":\"Rawezh\",\"driver\":\"5\",\"location\":\"سلێانی\",\"material_id\":1,\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"328000.00\",\"kg\":\"32000.00\",\"price\":\"0.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"139400\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0.00\",\"remaining_iqd\":\"328000\",\"bin_id\":1,\"price_per_kg_iqd\":\"10250.00\",\"price_per_kg_usd\":\"0.00\",\"invoice_number\":\"408\",\"date\":\"2025-08-06\"}', '{\"company_id\":\"27\",\"company_name\":\"Rawezh\",\"driver\":\"5\",\"location\":\"سلێانی\",\"material_id\":\"1\",\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"328000.00\",\"kg\":\"32000.00\",\"price\":\"328000.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0\",\"remaining_iqd\":\"328000.00\",\"bin_id\":\"1\",\"price_per_kg_iqd\":\"10250.00\",\"price_per_kg_usd\":\"0\",\"invoice_number\":\"408\",\"date\":\"2025-08-06\"}', '{\"action_type\":\"purchase_update\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":328000}', '::1'),
(281, 1, 'update', 'purchases', 60, 'کڕینەکە نوێکرایەوە (invoice: 408, کۆمپانیا: Rawezh, مادە: لمی ڕەش)', '2025-08-13 10:06:25', 0, '{\"company_id\":27,\"company_name\":\"Rawezh\",\"driver\":\"5\",\"location\":\"سلێانی\",\"material_id\":1,\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"328000.00\",\"kg\":\"32000.00\",\"price\":\"328000.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0.00\",\"remaining_iqd\":\"328000\",\"bin_id\":1,\"price_per_kg_iqd\":\"10250.00\",\"price_per_kg_usd\":\"0.00\",\"invoice_number\":\"408\",\"date\":\"2025-08-06\"}', '{\"company_id\":\"27\",\"company_name\":\"Rawezh\",\"driver\":\"test\",\"location\":\"سلێانی\",\"material_id\":\"1\",\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"328000.00\",\"kg\":\"32000.00\",\"price\":\"328000.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0\",\"remaining_iqd\":\"328000.00\",\"bin_id\":\"1\",\"price_per_kg_iqd\":\"10250.00\",\"price_per_kg_usd\":\"0\",\"invoice_number\":\"408\",\"date\":\"2025-08-06\"}', '{\"action_type\":\"purchase_update\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":328000}', '::1'),
(282, 1, 'update', 'purchases', 60, 'کڕینەکە نوێکرایەوە (invoice: 408, کۆمپانیا: Rawezh, مادە: لمی ڕەش)', '2025-08-13 10:10:49', 0, '{\"company_id\":27,\"company_name\":\"Rawezh\",\"driver\":\"test\",\"location\":\"سلێانی\",\"material_id\":1,\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"328000.00\",\"kg\":\"32000.00\",\"price\":\"328000.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0.00\",\"remaining_iqd\":\"328000\",\"bin_id\":1,\"price_per_kg_iqd\":\"10250.00\",\"price_per_kg_usd\":\"0.00\",\"invoice_number\":\"408\",\"date\":\"2025-08-06\"}', '{\"company_id\":\"27\",\"company_name\":\"Rawezh\",\"driver\":\"5\",\"location\":\"سلێانی\",\"material_id\":\"1\",\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"328000.00\",\"kg\":\"32000.00\",\"price\":\"328000.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0\",\"remaining_iqd\":\"328000.00\",\"bin_id\":\"1\",\"price_per_kg_iqd\":\"10250.00\",\"price_per_kg_usd\":\"0\",\"invoice_number\":\"408\",\"date\":\"2025-08-06\"}', '{\"action_type\":\"purchase_update\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":328000}', '::1'),
(283, 1, 'delete', 'purchases', 60, 'کڕینەکە سڕایەوە (invoice: 408, کۆمپانیا: Rawezh, مادە: لمی ڕەش)', '2025-08-13 10:11:15', 0, '{\"company_id\":27,\"company_name\":\"Rawezh\",\"driver\":\"5\",\"location\":\"سلێانی\",\"material_id\":1,\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"328000.00\",\"kg\":\"32000.00\",\"price\":\"328000.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0.00\",\"remaining_iqd\":\"328000\",\"bin_id\":1,\"price_per_kg_iqd\":\"10250.00\",\"price_per_kg_usd\":\"0.00\",\"invoice_number\":\"408\",\"date\":\"2025-08-06\"}', NULL, '{\"action_type\":\"purchase_deletion\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":328000}', '::1'),
(284, 1, 'delete', 'purchases', 58, 'کڕینەکە سڕایەوە (invoice: A-0140, کۆمپانیا: test, مادە: لمی ڕەش)', '2025-08-13 10:12:56', 0, '{\"company_id\":29,\"company_name\":\"test\",\"driver\":\"test\",\"location\":\"سلێانی\",\"material_id\":1,\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"369000.00\",\"kg\":\"36000.00\",\"price\":\"0.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"139050\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0.00\",\"remaining_iqd\":\"369000\",\"bin_id\":1,\"price_per_kg_iqd\":\"10250.00\",\"price_per_kg_usd\":\"0.00\",\"invoice_number\":\"A-0140\",\"date\":\"2025-07-27\"}', NULL, '{\"action_type\":\"purchase_deletion\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":369000}', '::1'),
(285, 1, 'delete', 'purchases', 57, 'کڕینەکە سڕایەوە (invoice: 123654, کۆمپانیا: Rawezh, مادە: لمی ڕەش)', '2025-08-13 10:12:58', 0, '{\"company_id\":27,\"company_name\":\"Rawezh\",\"driver\":\"test\",\"location\":\"سلێانی\",\"material_id\":1,\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"360000.00\",\"kg\":\"36000.00\",\"price\":\"0.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"150000\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0.00\",\"remaining_iqd\":\"360000\",\"bin_id\":1,\"price_per_kg_iqd\":\"10000.00\",\"price_per_kg_usd\":\"0.00\",\"invoice_number\":\"123654\",\"date\":\"2025-07-24\"}', NULL, '{\"action_type\":\"purchase_deletion\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":360000}', '::1'),
(286, 1, 'insert', 'purchases', 61, 'کڕینێکی نوێ زیادکرا (invoice: 408, کۆمپانیا: Rawezh, مادە: لمی ڕەش, بڕ: 32000 کگم)', '2025-08-13 10:14:02', 0, NULL, '{\"company_id\":\"27\",\"company_name\":\"Rawezh\",\"driver\":\"5\",\"location\":\"سلێانی\",\"material_id\":\"1\",\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"328000.00\",\"kg\":\"32000\",\"price\":\"328000.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0\",\"remaining_iqd\":\"328000.00\",\"bin_id\":\"2\",\"price_per_kg_iqd\":\"10250\",\"price_per_kg_usd\":\"0\",\"invoice_number\":\"408\",\"date\":\"2025-08-12\"}', '{\"action_type\":\"purchase_creation\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":328000}', '::1'),
(287, 1, 'update', 'purchases', 61, 'کڕینەکە نوێکرایەوە (invoice: 408, کۆمپانیا: Rawezh, مادە: چەو)', '2025-08-13 10:15:52', 0, '{\"company_id\":27,\"company_name\":\"Rawezh\",\"driver\":\"5\",\"location\":\"سلێانی\",\"material_id\":1,\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"328000.00\",\"kg\":\"32000.00\",\"price\":\"328000.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0.00\",\"remaining_iqd\":\"328000\",\"bin_id\":2,\"price_per_kg_iqd\":\"10250.00\",\"price_per_kg_usd\":\"0.00\",\"invoice_number\":\"408\",\"date\":\"2025-08-12\"}', '{\"company_id\":\"27\",\"company_name\":\"Rawezh\",\"driver\":\"5\",\"location\":\"سلێانی\",\"material_id\":\"2\",\"material_name\":\"چەو\",\"amount_iqd\":\"186656.00\",\"kg\":\"32000.00\",\"price\":\"186656.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0\",\"remaining_iqd\":\"186000\",\"bin_id\":\"3\",\"price_per_kg_iqd\":\"5833\",\"price_per_kg_usd\":\"0\",\"invoice_number\":\"408\",\"date\":\"2025-08-13\"}', '{\"action_type\":\"purchase_update\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":186000}', '::1');
INSERT INTO `notifications` (`id`, `user_id`, `action`, `table_name`, `record_id`, `description`, `created_at`, `seen`, `old_values`, `new_values`, `additional_info`, `ip_address`) VALUES
(288, 1, 'delete', 'purchases', 61, 'کڕینەکە سڕایەوە (invoice: 408, کۆمپانیا: Rawezh, مادە: چەو)', '2025-08-13 10:17:09', 0, '{\"company_id\":27,\"company_name\":\"Rawezh\",\"driver\":\"5\",\"location\":\"سلێانی\",\"material_id\":2,\"material_name\":\"چەو\",\"amount_iqd\":\"186656.00\",\"kg\":\"32000.00\",\"price\":\"186656.00\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"140300\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0.00\",\"remaining_iqd\":\"186000\",\"bin_id\":3,\"price_per_kg_iqd\":\"5833.00\",\"price_per_kg_usd\":\"0.00\",\"invoice_number\":\"408\",\"date\":\"2025-08-13\"}', NULL, '{\"action_type\":\"purchase_deletion\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":186000}', '::1'),
(289, 1, 'insert', 'sales', 16, 'فرۆشتنێکی نوێ زیادکرا (invoice: A-0003, کڕیار: test, فۆرمۆلا: SAQF 350, بڕ: 12 م³)', '2025-08-19 19:49:57', 0, NULL, '{\"customer_id\":\"32\",\"customer_name\":\"test\",\"formula_id\":\"17\",\"formula_name\":\"SAQF 350\",\"recipient\":\"ڕاوێژ\",\"location\":\"پیرەمەگرون\",\"quantity\":\"12\",\"price_per_unit\":\"45\",\"total_price\":\"540.0000\",\"payment_type\":\"قەرز\",\"amount_paid_usd\":\"0\",\"amount_paid_iq\":\"0\",\"remaining_amount\":\"540.0000\",\"dolar_rate\":\"141750\",\"discount\":\"0\",\"order_date\":\"2025-08-07\",\"invoice_number\":\"A-0003\",\"notes\":\"\"}', '{\"action_type\":\"sale_creation\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0}', '::1'),
(290, 1, 'insert', 'other_expenses', 24, 'خەرجی تر زیادکرا (invoice: , جۆر: بەکارهێنانی گاز, کەس: هیچ کەسێک نییە, کارمەند: ئامانج, سەیارە: M10)', '2025-08-24 09:23:40', 0, NULL, '{\"person_id\":null,\"person_name\":\"هیچ کەسێک نییە\",\"employee_id\":\"33\",\"employee_name\":\"ئامانج\",\"car_id\":\"12\",\"car_name\":\"M10\",\"gas_liters\":210,\"expense_type\":\"بەکارهێنانی گاز\",\"material_id\":null,\"material_name\":\"هیچ مادەیەک نییە\",\"material_quantity\":0,\"material_purchase_price_iqd\":0,\"material_purchase_price_usd\":0,\"material_total_cost\":0,\"gas_purchase_price_input\":556.13,\"gas_total_cost\":116787.3,\"payment_type\":\"نەقد\",\"currency_type\":\"دینار\",\"invoice_number\":\"\",\"amount_iqd\":0,\"amount_usd\":0,\"paid_iqd\":0,\"paid_usd\":0,\"exchange_rate\":142750,\"remaining_iqd\":0,\"remaining_usd\":0,\"date\":\"2025-08-24\"}', '{\"action_type\":\"other_expense_creation\",\"payment_status\":\"paid\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":0,\"expense_category\":\"بەکارهێنانی گاز\"}', '::1'),
(291, 1, 'insert', 'other_expenses', 25, 'خەرجی تر زیادکرا (invoice: , جۆر: بەکارهێنانی گاز, کەس: هیچ کەسێک نییە, کارمەند: دانا, سەیارە: M12)', '2025-08-24 09:24:16', 0, NULL, '{\"person_id\":null,\"person_name\":\"هیچ کەسێک نییە\",\"employee_id\":\"23\",\"employee_name\":\"دانا\",\"car_id\":\"14\",\"car_name\":\"M12\",\"gas_liters\":210,\"expense_type\":\"بەکارهێنانی گاز\",\"material_id\":null,\"material_name\":\"هیچ مادەیەک نییە\",\"material_quantity\":0,\"material_purchase_price_iqd\":0,\"material_purchase_price_usd\":0,\"material_total_cost\":0,\"gas_purchase_price_input\":876.55,\"gas_total_cost\":184075.5,\"payment_type\":\"نەقد\",\"currency_type\":\"دینار\",\"invoice_number\":\"\",\"amount_iqd\":0,\"amount_usd\":0,\"paid_iqd\":0,\"paid_usd\":0,\"exchange_rate\":142750,\"remaining_iqd\":0,\"remaining_usd\":0,\"date\":\"2025-08-24\"}', '{\"action_type\":\"other_expense_creation\",\"payment_status\":\"paid\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":0,\"expense_category\":\"بەکارهێنانی گاز\"}', '::1'),
(292, 1, 'insert', 'other_expenses', 26, 'خەرجی تر زیادکرا (invoice: , جۆر: بەکارهێنانی گاز, کەس: هیچ کەسێک نییە, کارمەند: هیچ کارمەندێک نییە, سەیارە: M12)', '2025-08-24 09:28:51', 0, NULL, '{\"person_id\":null,\"person_name\":\"هیچ کەسێک نییە\",\"employee_id\":null,\"employee_name\":\"هیچ کارمەندێک نییە\",\"car_id\":\"14\",\"car_name\":\"M12\",\"gas_liters\":100,\"expense_type\":\"بەکارهێنانی گاز\",\"material_id\":null,\"material_name\":\"هیچ مادەیەک نییە\",\"material_quantity\":0,\"material_purchase_price_iqd\":0,\"material_purchase_price_usd\":0,\"material_total_cost\":0,\"gas_purchase_price_input\":876.55,\"gas_total_cost\":87655,\"payment_type\":\"نەقد\",\"currency_type\":\"دینار\",\"invoice_number\":\"\",\"amount_iqd\":0,\"amount_usd\":0,\"paid_iqd\":0,\"paid_usd\":0,\"exchange_rate\":142750,\"remaining_iqd\":0,\"remaining_usd\":0,\"date\":\"2025-08-24\"}', '{\"action_type\":\"other_expense_creation\",\"payment_status\":\"paid\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":0,\"expense_category\":\"بەکارهێنانی گاز\"}', '::1'),
(293, 1, 'insert', 'purchases', 62, 'کڕینێکی نوێ زیادکرا (invoice: 1, کۆمپانیا: دەشتی, مادە: لمی ڕەش, بڕ: 31000 کگم)', '2025-08-28 19:34:28', 0, NULL, '{\"company_id\":\"31\",\"company_name\":\"دەشتی\",\"driver\":\"test\",\"location\":\"سلێانی\",\"material_id\":\"1\",\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"317750.00\",\"kg\":\"31000\",\"price\":\"0\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"141800\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0\",\"remaining_iqd\":\"317750.00\",\"bin_id\":\"2\",\"price_per_kg_iqd\":\"10250\",\"price_per_kg_usd\":\"0\",\"invoice_number\":\"1\",\"date\":\"2025-08-27\"}', '{\"action_type\":\"purchase_creation\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":317750}', '::1'),
(294, 1, 'insert', 'purchases', 63, 'کڕینێکی نوێ زیادکرا (invoice: 5, کۆمپانیا: دەشتی, مادە: لمی ڕەش, بڕ: 31450 کگم)', '2025-08-28 19:34:58', 0, NULL, '{\"company_id\":\"31\",\"company_name\":\"دەشتی\",\"driver\":\"test\",\"location\":\"سلێانی\",\"material_id\":\"1\",\"material_name\":\"لمی ڕەش\",\"amount_iqd\":\"322362.50\",\"kg\":\"31450\",\"price\":\"0\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"141800\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0\",\"remaining_iqd\":\"322362.50\",\"bin_id\":\"2\",\"price_per_kg_iqd\":\"10250\",\"price_per_kg_usd\":\"0\",\"invoice_number\":\"5\",\"date\":\"2025-08-21\"}', '{\"action_type\":\"purchase_creation\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":322362.5}', '::1'),
(295, 1, 'insert', 'purchases', 65, 'کڕینێکی نوێ زیادکرا (invoice: 5468, کۆمپانیا: سۆران, مادە: چەو, بڕ: 32000 کگم)', '2025-09-11 16:33:23', 0, NULL, '{\"company_id\":\"32\",\"company_name\":\"سۆران\",\"driver\":\"test\",\"location\":\"سلێانی\",\"material_id\":\"2\",\"material_name\":\"چەو\",\"amount_iqd\":\"186656.00\",\"kg\":\"32000\",\"price\":\"0\",\"payment_type\":\"قەرز\",\"exchange_rate\":\"141800\",\"type\":\"دینار\",\"paid_usd\":\"0\",\"paid_iqd\":\"0\",\"remaining_usd\":\"0\",\"remaining_iqd\":\"186656.00\",\"bin_id\":\"3\",\"price_per_kg_iqd\":\"5833\",\"price_per_kg_usd\":\"0\",\"invoice_number\":\"5468\",\"date\":\"2025-09-10\"}', '{\"action_type\":\"purchase_creation\",\"payment_status\":\"credit\",\"currency_used\":\"none\",\"total_paid\":0,\"remaining_debt\":186656}', '::1'),
(296, 1, 'insert', 'customer_debt_payments', 7, 'پارەدان بۆ قەرزی کڕیار زیادکرا (کڕیار: test, تەلەفۆن: 07709245644)', '2025-09-18 09:17:19', 0, NULL, '{\"customer_id\":\"32\",\"customer_name\":\"test\",\"customer_phone\":\"07709245644\",\"date\":\"2025-09-18\",\"dolar_rate\":142850,\"paid_usd\":4.03,\"paid_iqd\":0,\"discount\":0,\"note\":\"\",\"from_opening_debt_usd\":4.03,\"from_sales_usd\":0}', '{\"action_type\":\"customer_debt_payment\",\"payment_method\":\"USD\",\"total_paid_usd_equivalent\":4.03,\"debt_reduction_type\":\"opening_debt\"}', '::1'),
(297, 1, 'insert', 'customer_debt_payments', 8, 'پارەدان بۆ قەرزی کڕیار زیادکرا (کڕیار: test, تەلەفۆن: 07709245644)', '2025-09-18 09:19:02', 0, NULL, '{\"customer_id\":\"32\",\"customer_name\":\"test\",\"customer_phone\":\"07709245644\",\"date\":\"2025-09-18\",\"dolar_rate\":142850,\"paid_usd\":990,\"paid_iqd\":0,\"discount\":0,\"note\":\"\",\"from_opening_debt_usd\":0,\"from_sales_usd\":990}', '{\"action_type\":\"customer_debt_payment\",\"payment_method\":\"USD\",\"total_paid_usd_equivalent\":990,\"debt_reduction_type\":\"sales_debt\"}', '::1'),
(298, 1, 'insert', 'customer_debt_payments', 9, 'پارەدان بۆ قەرزی کڕیار زیادکرا (کڕیار: test, تەلەفۆن: 07709245644)', '2025-09-18 09:21:25', 0, NULL, '{\"customer_id\":\"32\",\"customer_name\":\"test\",\"customer_phone\":\"07709245644\",\"date\":\"2025-09-18\",\"dolar_rate\":142850,\"paid_usd\":11,\"paid_iqd\":0,\"discount\":0,\"note\":\"\",\"from_opening_debt_usd\":10,\"from_sales_usd\":0}', '{\"action_type\":\"customer_debt_payment\",\"payment_method\":\"USD\",\"total_paid_usd_equivalent\":11,\"debt_reduction_type\":\"opening_debt\"}', '::1'),
(299, 1, 'delete', 'customer_debt_payments', 9, 'پارەدانی قەرزی کڕیار سڕایەوە (کڕیار: test, تەلەفۆن: 07709245644)', '2025-09-18 09:21:34', 0, '{\"customer_id\":32,\"customer_name\":\"test\",\"customer_phone\":\"07709245644\",\"date\":\"2025-09-18\",\"dolar_rate\":142850,\"paid_usd\":11,\"paid_iqd\":0,\"discount\":0,\"note\":\"\",\"from_opening_debt_usd\":10,\"from_sales_usd\":0}', NULL, '{\"action_type\":\"customer_debt_payment_deletion\",\"payment_method\":\"USD\",\"total_paid_usd_equivalent\":11,\"debt_reduction_type\":\"opening_debt\"}', '::1'),
(300, 1, 'insert', 'customer_debt_payments', 10, 'پارەدان بۆ قەرزی کڕیار زیادکرا (کڕیار: test, تەلەفۆن: 07709245644)', '2025-09-18 09:25:02', 0, NULL, '{\"customer_id\":\"32\",\"customer_name\":\"test\",\"customer_phone\":\"07709245644\",\"date\":\"2025-09-18\",\"dolar_rate\":142850,\"paid_usd\":11,\"paid_iqd\":0,\"discount\":0,\"note\":\"\",\"from_opening_debt_usd\":10,\"from_sales_usd\":0}', '{\"action_type\":\"customer_debt_payment\",\"payment_method\":\"USD\",\"total_paid_usd_equivalent\":11,\"debt_reduction_type\":\"opening_debt\"}', '::1'),
(301, 1, 'delete', 'customer_debt_payments', 10, 'پارەدانی قەرزی کڕیار سڕایەوە (کڕیار: test, تەلەفۆن: 07709245644)', '2025-09-18 09:25:09', 0, '{\"customer_id\":32,\"customer_name\":\"test\",\"customer_phone\":\"07709245644\",\"date\":\"2025-09-18\",\"dolar_rate\":142850,\"paid_usd\":11,\"paid_iqd\":0,\"discount\":0,\"note\":\"\",\"from_opening_debt_usd\":10,\"from_sales_usd\":0}', NULL, '{\"action_type\":\"customer_debt_payment_deletion\",\"payment_method\":\"USD\",\"total_paid_usd_equivalent\":11,\"debt_reduction_type\":\"opening_debt\"}', '::1'),
(302, 1, 'insert', 'customer_debt_payments', 11, 'پارەدان بۆ قەرزی کڕیار زیادکرا (کڕیار: test, تەلەفۆن: 07709245644)', '2025-09-18 09:26:57', 0, NULL, '{\"customer_id\":\"32\",\"customer_name\":\"test\",\"customer_phone\":\"07709245644\",\"date\":\"2025-09-18\",\"dolar_rate\":142850,\"paid_usd\":5,\"paid_iqd\":0,\"discount\":0,\"note\":\"\",\"from_opening_debt_usd\":5,\"from_sales_usd\":0}', '{\"action_type\":\"customer_debt_payment\",\"payment_method\":\"USD\",\"total_paid_usd_equivalent\":5,\"debt_reduction_type\":\"opening_debt\"}', '::1'),
(303, 1, 'delete', 'customer_debt_payments', 11, 'پارەدانی قەرزی کڕیار سڕایەوە (کڕیار: test, تەلەفۆن: 07709245644)', '2025-09-18 09:27:05', 0, '{\"customer_id\":32,\"customer_name\":\"test\",\"customer_phone\":\"07709245644\",\"date\":\"2025-09-18\",\"dolar_rate\":142850,\"paid_usd\":5,\"paid_iqd\":0,\"discount\":0,\"note\":\"\",\"from_opening_debt_usd\":5,\"from_sales_usd\":0}', NULL, '{\"action_type\":\"customer_debt_payment_deletion\",\"payment_method\":\"USD\",\"total_paid_usd_equivalent\":5,\"debt_reduction_type\":\"opening_debt\"}', '::1'),
(304, 1, 'insert', 'customer_debt_payments', 12, 'پارەدان بۆ قەرزی کڕیار زیادکرا (کڕیار: test, تەلەفۆن: 07709245644)', '2025-09-18 09:32:46', 0, NULL, '{\"customer_id\":\"32\",\"customer_name\":\"test\",\"customer_phone\":\"07709245644\",\"date\":\"2025-09-18\",\"dolar_rate\":143000,\"paid_usd\":0,\"paid_iqd\":643000,\"discount\":0.3496,\"note\":\"\",\"from_opening_debt_usd\":0,\"from_sales_usd\":449.99994965034966}', '{\"action_type\":\"customer_debt_payment\",\"payment_method\":\"IQD\",\"total_paid_usd_equivalent\":449.99994965034966,\"debt_reduction_type\":\"sales_debt\"}', '::1');
...
(19, 'خەرجی گاز بۆ سەیارەی M15', NULL, 33, 17, NULL, 'نەقد', 'دۆلار', 'GAS-001', 0.00, 50.00, 0.00, 0.00, 150000.00, 0.00, 0.00, '2025-08-15', 'بەکارهێنانی گاز', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(20, 'خەرجی خواردنگە بۆ شۆفێر', NULL, 33, 17, NULL, 'نەقد', 'دینار', 'FOOD-001', 15000.00, 0.00, 0.00, 0.00, 150000.00, 0.00, 0.00, '2025-08-15', 'خواردنگە', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(21, 'خەرجی ئۆفیس', NULL, 23, 18, NULL, 'نەقد', 'دۆلار', 'OFFICE-001', 0.00, 25.00, 0.00, 0.00, 150000.00, 0.00, 0.00, '2025-08-15', 'ئۆفیس', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(22, 'خەرجی گاز بۆ سەیارەی M10', NULL, 30, 12, NULL, 'نەقد', 'دۆلار', 'GAS-002', 0.00, 75.00, 0.00, 0.00, 150000.00, 0.00, 0.00, '2025-08-14', 'بەکارهێنانی گاز', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(23, 'خەرجی کاڵای کۆگا', NULL, 25, 13, NULL, 'نەقد', 'دینار', 'MAT-001', 25000.00, 0.00, 0.00, 0.00, 150000.00, 0.00, 0.00, '2025-08-14', 'بەکارهێنانی کاڵای کۆگا', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(24, '', NULL, 33, 12, 210.00, 'نەقد', 'دینار', '', 0.00, 0.00, 0.00, 0.00, 142750.00, 0.00, 0.00, '2025-08-24', 'بەکارهێنانی گاز', 0.00, 556.13, 0.00, 0.00, NULL, 0.00, 116787.30, NULL, NULL, NULL),
(25, '', NULL, 23, 14, 210.00, 'نەقد', 'دینار', '', 0.00, 0.00, 0.00, 0.00, 142750.00, 0.00, 0.00, '2025-08-24', 'بەکارهێنانی گاز', 0.00, 556.13, 0.00, 0.00, NULL, 0.00, 116787.30, NULL, NULL, NULL),
(26, '', NULL, NULL, 14, 100.00, 'نەقد', 'دینار', '', 0.00, 0.00, 0.00, 0.00, 142750.00, 0.00, 0.00, '2025-08-24', 'بەکارهێنانی گاز', 0.00, 556.13, 0.00, 0.00, NULL, 0.00, 55613.00, NULL, NULL, NULL);
...
(62, '2025-08-27', '1', 'test', 'سلێانی', 1, 31000.00, 0.00, 'قەرز', 141800, 31, 'دینار', 0, 0, 0.00, 317000, 2, 317000.00, 10250.00, 0.00),
(63, '2025-08-21', '5', 'test', 'سلێانی', 1, 31450.00, 0.00, 'قەرز', 141800, 31, 'دینار', 0, 0, 0.00, 322000, 2, 322000.00, 10250.00, 0.00),
(64, '2025-09-10', '151', '5', 'سلێانی', 2, 32000.00, 0.00, 'قەرز', 141800, 27, 'دینار', 0, 0, 0.00, 186656, 4, 186656.00, 5833.00, 0.00),
(65, '2025-08-06', '5468', 'test', 'سلێانی', 2, 32000.00, 0.00, 'قەرز', 141800, 32, 'دینار', 0, 0, 0.00, 175000, 3, 175000.00, 5833.00, 0.00);
...
(63, 60, '2025-08-06', '408', '5', 'سلێانی', 1, 32000.00, 328000.00, 'قەرز', 140300, 27, 'دینار', 0, 0, 0.00, 328000, 1, 328000.00, 10250.00, 0.00, '2025-08-13 10:11:15'),
(64, 58, '2025-07-27', 'A-0140', 'test', 'سلێانی', 1, 36000.00, 0.00, 'قەرز', 139050, 29, 'دینار', 0, 0, 0.00, 369000, 1, 369000.00, 10250.00, 0.00, '2025-08-13 10:11:18'),
(65, 58, '2025-07-27', 'A-0140', 'test', 'سلێانی', 1, 36000.00, 0.00, 'قەرز', 139050, 29, 'دینار', 0, 0, 0.00, 369000, 1, 369000.00, 10250.00, 0.00, '2025-08-13 10:11:21'),
(66, 58, '2025-07-27', 'A-0140', 'test', 'سلێانی', 1, 36000.00, 0.00, 'قەرز', 139050, 29, 'دینار', 0, 0, 0.00, 369000, 1, 369000.00, 10250.00, 0.00, '2025-08-13 10:12:56'),
(67, 57, '2025-07-24', '123654', 'test', 'سلێانی', 1, 36000.00, 0.00, 'قەرز', 150000, 27, 'دینار', 0, 0, 0.00, 360000, 1, 360000.00, 10000.00, 0.00, '2025-08-13 10:12:58'),
(68, 61, '2025-08-13', '408', '5', 'سلێانی', 2, 32000.00, 186656.00, 'قەرز', 140300, 27, 'دینار', 0, 0, 0.00, 186000, 3, 186656.00, 5833.00, 0.00, '2025-08-13 10:17:09');
...
(12, 32, '', 'سلێمانی', 10.00, 45.00, 450.00, 'قەرز', 0.00, 0.00, 139050.00, 0.00, 'A-0140', '2025-07-27', '', 17, 0.00),
(13, 32, '', 'پیرەمەگرون', 10.00, 45.00, 450.00, 'قەرز', 0.00, 0.00, NULL, NULL, '12', '2025-08-02', '', 17, 0.00),
(14, 32, 'وستا ازاد', 'پیرەمەگرون', 10.00, 45.00, 450.00, 'قەرز', 0.00, 0.00, 139450.00, 0.00, '12', '2025-08-02', '', 18, 0.00),
(15, 32, 'وستا ازاد', 'پیرەمەگرون', 10.00, 45.00, 450.00, 'قەرز', 0.00, 0.00, 139450.00, 450.00, '125', '2025-08-02', '', 22, 0.00),
(16, 32, 'ڕاوێژ', 'پیرەمەگرون', 12.00, 45.00, 540.00, 'قەرز', 0.00, 0.00, 141750.00, 0.00, 'A-0003', '2025-08-07', '', 17, 0.00);
...
ALTER TABLE `customer_payment_allocations`
  ...
  ADD KEY `idx_debt_payment_sale` (`debt_payment_id`,`sale_id`);
...
--
-- Indexes for table `monthly_material_stock`
--
ALTER TABLE `monthly_material_stock`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_bin_month` (`bin_id`,`month_year`),
  ADD KEY `idx_month_year` (`month_year`),
  ADD KEY `idx_bin_id` (`bin_id`),
  ADD KEY `idx_recorded_date` (`recorded_date`),
  ADD KEY `fk_monthly_stock_user` (`created_by`);
...
--
-- AUTO_INCREMENT for table `monthly_material_stock`
--
ALTER TABLE `monthly_material_stock`
...
--
ALTER TABLE `customer_payment_allocations`
  ADD CONSTRAINT `customer_payment_allocations_ibfk_1` FOREIGN KEY (`debt_payment_id`) REFERENCES `customer_debt_payments` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `customer_payment_allocations_ibfk_2` FOREIGN KEY (`sale_id`) REFERENCES `sales` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `monthly_material_stock`
--
ALTER TABLE `monthly_material_stock`
  ADD CONSTRAINT `fk_monthly_stock_bin` FOREIGN KEY (`bin_id`) REFERENCES `bins_silos` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_monthly_stock_user` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
