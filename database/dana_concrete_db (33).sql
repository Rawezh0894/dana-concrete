...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 17, 2025 at 12:12 PM
...
(1, 'A-0001', 21, 'پیرەمەگروون ', 20.00, 23, 8, 35, 9, 36, '2025-07-13 06:32:05', NULL),
(2, 'A-0002', 21, 'سلێمانی', 20.00, 30, 8, 38, 9, 38, '2025-07-17 13:05:21', NULL);

--
-- Triggers `concrete_receipts`
--
DELIMITER $$
CREATE TRIGGER `trg_concrete_receipts_delete_notify` AFTER DELETE ON `concrete_receipts` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'delete', 'concrete_receipts', OLD.id, CONCAT('پسوڵەی کۆنکرێت سڕایەوە (شماره: ', OLD.receipt_number, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_concrete_receipts_insert_notify` AFTER INSERT ON `concrete_receipts` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'insert', 'concrete_receipts', NEW.id, CONCAT('پسوڵەی کۆنکرێت زیادکرا (شماره: ', NEW.receipt_number, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_concrete_receipts_update_notify` AFTER UPDATE ON `concrete_receipts` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'update', 'concrete_receipts', NEW.id, CONCAT('پسوڵەی کۆنکرێت نوێکرایەوە (شماره: ', NEW.receipt_number, ')'));
END
$$
DELIMITER ;
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_customer_debt_payments_delete_notify` AFTER DELETE ON `customer_debt_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'delete', 'customer_debt_payments', OLD.id, CONCAT('پارەدانی قەرزی کڕیار سڕایەوە (کڕیار: ', OLD.customer_id, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_customer_debt_payments_insert_notify` AFTER INSERT ON `customer_debt_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'insert', 'customer_debt_payments', NEW.id, CONCAT('پارەدان بۆ قەرزی کڕیار زیادکرا (کڕیار: ', NEW.customer_id, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_customer_debt_payments_update_notify` AFTER UPDATE ON `customer_debt_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'update', 'customer_debt_payments', NEW.id, CONCAT('پارەدانی قەرزی کڕیار نوێکرایەوە (کڕیار: ', NEW.customer_id, ')'));
END
$$
DELIMITER ;
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_debt_payments_delete_notify` AFTER DELETE ON `debt_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (OLD.created_by, 'delete', 'debt_payments', OLD.id, CONCAT('پارەدانی قەرزی کۆمپانیا سڕایەوە (کۆمپانیا: ', OLD.company_id, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_debt_payments_insert_notify` AFTER INSERT ON `debt_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NEW.created_by, 'insert', 'debt_payments', NEW.id, CONCAT('پارەدان بۆ قەرزی کۆمپانیا زیادکرا (کۆمپانیا: ', NEW.company_id, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_debt_payments_update_notify` AFTER UPDATE ON `debt_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NEW.created_by, 'update', 'debt_payments', NEW.id, CONCAT('پارەدانی قەرزی کۆمپانیا نوێکرایەوە (کۆمپانیا: ', NEW.company_id, ')'));
END
$$
DELIMITER ;
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_employee_payments_delete_notify` AFTER DELETE ON `employee_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'delete', 'employee_payments', OLD.id, CONCAT('پارەدانی کارمەند سڕایەوە (کارمەند: ', OLD.employee_id, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_employee_payments_insert_notify` AFTER INSERT ON `employee_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'insert', 'employee_payments', NEW.id, CONCAT('پارەدان بە کارمەند زیادکرا (کارمەند: ', NEW.employee_id, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_employee_payments_update_notify` AFTER UPDATE ON `employee_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'update', 'employee_payments', NEW.id, CONCAT('پارەدانی کارمەند نوێکرایەوە (کارمەند: ', NEW.employee_id, ')'));
END
$$
DELIMITER ;
...
(1, NULL, 'insert', 'sales', 5, 'فرۆشتنێکی نوێ زیادکرا (invoice: 123)', '2025-07-17 13:03:24', 0),
(2, NULL, 'insert', 'concrete_receipts', 2, 'پسوڵەی کۆنکرێت زیادکرا (شماره: A-0002)', '2025-07-17 13:05:21', 0);
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_other_expenses_delete_notify` AFTER DELETE ON `other_expenses` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'delete', 'other_expenses', OLD.id, CONCAT('خەرجی تر سڕایەوە (invoice: ', OLD.invoice_number, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_other_expenses_insert_notify` AFTER INSERT ON `other_expenses` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'insert', 'other_expenses', NEW.id, CONCAT('خەرجی تر زیادکرا (invoice: ', NEW.invoice_number, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_other_expenses_update_notify` AFTER UPDATE ON `other_expenses` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'update', 'other_expenses', NEW.id, CONCAT('خەرجی تر نوێکرایەوە (invoice: ', NEW.invoice_number, ')'));
END
$$
DELIMITER ;
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_person_other_expenses_debt_payments_delete_notify` AFTER DELETE ON `person_other_expenses_debt_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'delete', 'person_other_expenses_debt_payments', OLD.id, CONCAT('پارەدانی قەرزی کەسانی تر سڕایەوە (کەس: ', OLD.person_id, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_person_other_expenses_debt_payments_insert_notify` AFTER INSERT ON `person_other_expenses_debt_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'insert', 'person_other_expenses_debt_payments', NEW.id, CONCAT('پارەدان بۆ قەرزی کەسانی تر زیادکرا (کەس: ', NEW.person_id, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_person_other_expenses_debt_payments_update_notify` AFTER UPDATE ON `person_other_expenses_debt_payments` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'update', 'person_other_expenses_debt_payments', NEW.id, CONCAT('پارەدانی قەرزی کەسانی تر نوێکرایەوە (کەس: ', NEW.person_id, ')'));
END
$$
DELIMITER ;
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_purchases_delete_notify` AFTER DELETE ON `purchases` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'delete', 'purchases', OLD.id, CONCAT('کڕینەکە سڕایەوە (invoice: ', OLD.invoice_number, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_purchases_insert_notify` AFTER INSERT ON `purchases` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'insert', 'purchases', NEW.id, CONCAT('کڕینێکی نوێ زیادکرا (invoice: ', NEW.invoice_number, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_purchases_update_notify` AFTER UPDATE ON `purchases` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'update', 'purchases', NEW.id, CONCAT('کڕینەکە نوێکرایەوە (invoice: ', NEW.invoice_number, ')'));
END
$$
DELIMITER ;
...
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_sales_delete_notify` AFTER DELETE ON `sales` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'delete', 'sales', OLD.id, CONCAT('فرۆشتنەکە سڕایەوە (invoice: ', OLD.invoice_number, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_sales_insert_notify` AFTER INSERT ON `sales` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'insert', 'sales', NEW.id, CONCAT('فرۆشتنێکی نوێ زیادکرا (invoice: ', NEW.invoice_number, ')'));
END
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `trg_sales_update_notify` AFTER UPDATE ON `sales` FOR EACH ROW BEGIN
  INSERT INTO notifications (user_id, action, table_name, record_id, description)
  VALUES (NULL, 'update', 'sales', NEW.id, CONCAT('فرۆشتنەکە نوێکرایەوە (invoice: ', NEW.invoice_number, ')'));
END
$$
DELIMITER ;
