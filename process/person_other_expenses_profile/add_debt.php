...
try {
    ...
    // We allow tolerance for floating point math
    ...
    if ($total_payment_value_usd - $total_debt_value_usd > 1.0) { // Allow $1 tolerance/rounding
        echo json_encode(['success' => false, 'msg' => 'بڕی پارەی دراو زیاترە لە کۆی گشتی قەرز!']);
        exit;
    }
