...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            /* Ensure print preview matches screen layout */
            body {
            ...
            /* Keep same font sizes as screen */
            .receipt-header {
                border-bottom: 6px solid var(--seafoam-green) !important;
            ...
            .receipt-table-custom {
                font-size: 1rem !important;
                margin-bottom: 1rem !important;
            }
            
            .receipt-table-custom th,
            .receipt-table-custom td {
