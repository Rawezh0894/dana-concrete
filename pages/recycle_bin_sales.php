...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ڕیسایکڵ بین - فرۆشتنە سڕدراوەکان</title>
...
<div class="container-fluid py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0" style="color: var(--seafoam-green); font-weight: bold;">ڕیسایکڵ بین - فرۆشتنە سڕدراوەکان</h2>
    </div>
    <div class="row mb-3">
      <div class="col-md-3">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle text-center" id="recycleBinSalesTable">
...
<script src="../assets/js/sale/select_recycle_bin_sales.js" nonce="<?php echo $csp_nonce; ?>"></script>
</body>
</html> 