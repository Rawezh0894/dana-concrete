...
<div class="container-fluid">
    ...
    <!-- 
    ====================================================================
    شیکردنەوەی هەژمارکردنی تێکڕای نرخی مەوادی بەکارهاتوو
    ====================================================================
    
    چۆنیەتی هەژمارکردنی تێکڕای نرخی مەوادی بەکارهاتوو:
    
    ١. وەرگرتنی کڕینەکان لە بەرواری دیاریکراو:
       - لە یەکەم هەوڵدا، کڕینەکان لە بەرواری فلتەرکراو وەردەگرێت
       - بۆ هەر جۆرێکی مەواد (لم، چەو، چیمەنتۆ، دەرمان، گاز)
    
    ٢. گۆڕینی نرخەکان بۆ دۆلار:
       - ئەگەر کڕین بە دۆلار بێت:
         * یەکەم: بەکارهێنانی price_per_kg_usd × kg (نرخ بۆ کیلۆگرام)
         * Fallback: ئەگەر price_per_kg_usd بەتاڵ بێت، بەکارهێنانی price (کۆی نرخ)
       - ئەگەر کڕین بە دینار بێت:
         * یەکەم: بەکارهێنانی (price_per_kg_iqd × kg) / (exchange_rate / 100)
         * Fallback: ئەگەر price_per_kg_iqd بەتاڵ بێت، بەکارهێنانی amount_iqd / (exchange_rate / 100)
       - تێبینی: ئەم گۆڕانکارییە بۆ ئەوەیە کە تێکڕای نرخ بە دروستی هەژمار بکرێت
    
    ٣. هەژمارکردنی تێکڕای نرخ بۆ هەر مەوادێک:
       - بۆ مەوادەکان (لم، چەو، چیمەنتۆ، دەرمان):
         تێکڕای نرخ بۆ تۆن = (کۆی نرخی دۆلار / کۆی کیلۆگرام) × ١٠٠٠
         
       - بۆ گاز (چونکە بە لیتر پێوانە دەکرێت):
         تێکڕای نرخ بۆ لیتر = کۆی نرخی دۆلار / کۆی کیلۆگرام
    
    ٤. Fallback (ئەگەر نرخ نەدۆزرایەوە):
       - ئەگەر لە بەرواری دیاریکراودا کڕین نەبێت،
       - کۆی گشتی کڕینەکان لە هەموو کاتەکان وەردەگرێت
       - و تێکڕای نرخی گشتی بەکاردێت
    
    ٥. هەژمارکردنی تێچووی بەکارهێنان:
       - بۆ هەر مەوادێک:
         تێچوو = بڕی بەکارهاتوو (بە تۆن) × تێکڕای نرخ (بۆ تۆن)
       - بۆ گاز:
         تێچوو = بڕی بەکارهاتوو (بە لیتر) × تێکڕای نرخ (بۆ لیتر)
    
    نموونە:
    - ئەگەر ١٠ تۆن لمی کەسارە بەکارهاتوو بێت
    - و تێکڕای نرخی لمی کەسارە ٥٠ دۆلار بۆ تۆن بێت
    - تێچوو = ١٠ × ٥٠ = ٥٠٠ دۆلار
