...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>ڕیسایکڵ بین - کڕینە سڕدراوەکان</title>
...
<div class="container-fluid py-5">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle text-center" id="recycleBinTable">
...
<script src="../assets/js/purchase/select_recycle_bin_purchases.js" nonce="<?php echo $csp_nonce; ?>"></script>
<script nonce="<?php echo $csp_nonce; ?>">
// Remove all inline alert/confirm logic from here. All confirmation and result messages are handled in select_recycle_bin_purchases.js using Swal.fire.
</script>
</body>
</html> 