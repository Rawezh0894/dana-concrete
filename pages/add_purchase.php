        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="number" class="form-control" id="exchange_rate" name="exchange_rate" min="1" step="1" required placeholder="چاوەڕوان بە...">
            </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="number" class="form-control" id="edit_exchange_rate" name="exchange_rate" min="1" step="1" required placeholder="چاوەڕوان بە...">
            </div>
            <div class="col-md-6 mb-3">
