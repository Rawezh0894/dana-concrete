            ...
            <form id="addNoteForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="mixer_car_id" class="form-label">میکسەر</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="pump_car_id" class="form-label">پەمپ</label>
            ...
            <form id="editNoteForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="edit_mixer_car_id" class="form-label">میکسەر</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="edit_pump_car_id" class="form-label">پەمپ</label>
