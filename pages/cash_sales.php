...
<div class="container-fluid py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0" style="color: var(--seafoam-green); font-weight: bold;">فرۆشتنی نەقد</h2>
    </div>
    <div class="row mb-3">
      <div class="col-md-3">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle text-center " id="cashSaleTable">
            ...
            <tbody>
                <!-- Cash sales will be loaded here by JS -->
            </tbody>
        </table>
    </div>
</div>
...
<script src="../assets/js/sale/select_cash_sale.js" nonce="<?php echo $csp_nonce; ?>"></script>
</body>
</html> 