...
<script src="https://cdn.datatables.net/1.13.4/js/jquery.dataTables.min.js" nonce="<?php echo $csp_nonce; ?>"></script>
<script src="https://cdn.datatables.net/1.13.4/js/dataTables.bootstrap5.min.js" nonce="<?php echo $csp_nonce; ?>"></script>
...
<script src="../assets/js/add_material/sales_history.js" nonce="<?php echo $csp_nonce; ?>"></script>
