      ...
      <form id="addBinForm">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="average_price" name="average_price" min="0" step="0.000001" required>
          </div>
        </div>
      ...
      <form id="editBinForm">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="number" class="form-control" id="edit_average_price" name="average_price" min="0" step="0.000001" required>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">داخستن</button>
