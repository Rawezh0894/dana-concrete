...
<aside class="sidebar" id="sidebar">
  ...
  <ul class="sidebar-menu list-unstyled">
    ...
    <li class="sidebar-group">
      <button class="sidebar-group-toggle d-flex align-items-center w-100" data-bs-target="#mainMenu" aria-expanded="<?php echo $is_main_menu_open ? 'true' : 'false'; ?>">
    ...
    <!-- All other dropdowns -->
    <li class="sidebar-group">
      <button class="sidebar-group-toggle d-flex align-items-center w-100" data-bs-target="#concreteMenu" aria-expanded="false">
      ...
      <ul class="sidebar-submenu" id="concreteMenu">
        ...
        <?php if (hasPermission('view_service_receipts')): ?>
          <li><a href="../pages/service_receipts.php" class="sidebar-link<?php if($current_page == 'service_receipts.php') echo ' active'; ?>"><i class="bi bi-gear-wide-connected me-2"></i> بەکرێدانی ئامێرەکان</a></li>
        <?php endif; ?>
        <?php if (hasPermission('view_service_customers')): ?>
          <li><a href="../pages/service_customers.php" class="sidebar-link<?php if($current_page == 'service_customers.php') echo ' active'; ?>"><i class="bi bi-people-fill me-2"></i> وەرگری ئامێرە کرێکان</a></li>
        <?php endif; ?>
      </ul>
    </li>
    <li class="sidebar-group">
      <button class="sidebar-group-toggle d-flex align-items-center w-100" data-bs-target="#materialsAccountsMenu" aria-expanded="false">
    ...
    <li class="sidebar-group">
      <button class="sidebar-group-toggle d-flex align-items-center w-100" data-bs-target="#vouchersMenu" aria-expanded="false">
    ...
    <li class="sidebar-group">
      <button class="sidebar-group-toggle d-flex align-items-center w-100" data-bs-target="#expensesMenu" aria-expanded="false">
      ...
      <ul class="sidebar-submenu" id="expensesMenu">
        ...
        <?php if (hasPermission('view_income_from_cars')): ?>
          <li><a href="../pages/income_from_cars.php" class="sidebar-link<?php if($current_page == 'income_from_cars.php') echo ' active'; ?>"><i class="bi bi-graph-up-arrow me-2"></i>وردەکاری بارکردنەکان</a></li>
        <?php endif; ?>
    ...
    <li class="sidebar-group">
      <button class="sidebar-group-toggle d-flex align-items-center w-100" data-bs-target="#factoryTrucksMenu" aria-expanded="false">
    ...
    <li class="sidebar-group">
      <button class="sidebar-group-toggle d-flex align-items-center w-100" data-bs-target="#newInventoryMenu" aria-expanded="false">
    ...
    <!-- System Management Dropdown -->
    <li class="sidebar-group">
      <button class="sidebar-group-toggle d-flex align-items-center w-100" data-bs-target="#systemMenu" aria-expanded="false">
