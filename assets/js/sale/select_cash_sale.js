async function loadCashSales() {
    ...
    let url = '../process/sale/select_cash_sale.php';
    const params = [];
    ...
    try {
        ...
        console.error('Raw response from select_cash_sale.php:', text);
    ...
    TableController.renderWithPagination('#cashSaleTable', mapped, columns, { pageSize: 10 });
}
document.addEventListener('DOMContentLoaded', loadCashSales);

document.getElementById('filter_from').addEventListener('input', loadCashSales);
document.getElementById('filter_to').addEventListener('input', loadCashSales);
